#Auidio
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/proprietary/bin/aplay:system/bin/aplay \
    ...
    $(LOCAL_PATH)/proprietary/etc/audio_effects.conf:system/etc/audio_effects.conf \
    $(LOCAL_PATH)/proprietary/etc/audio_policy.conf:system/etc/audio_policy.conf \
    $(LOCAL_PATH)/proprietary/lib/hw/audio.primary.msm8960.so:system/lib/hw/audio.primary.msm8960.so \
    $(LOCAL_PATH)/proprietary/lib/hw/audio_policy.msm8960.so:system/lib/hw/audio_policy.msm8960.so \
    $(LOCAL_PATH)/proprietary/lib/libalsa-intf.so:system/lib/libalsa-intf.so \
